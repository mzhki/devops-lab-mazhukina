...
Мне всегда было интересно, как работают IT-специалисты, особенно в области DevOps, поэтому в этом семестре (2026 год) я выбрала это направление для изучения. 
...
Создана отдельная ветка `develop` для дальнейшей разработки. В `main` хранится стабильная версия, а вся работа ведётся в отдельных ветках.
...
Pull Request позволяет проверить все изменения перед тем, как они попадут в стабильную версию проекта. В описании Pull Request были указаны все внесённые изменения.
...
2. Настроены SSH-ключи для безопасной работы
3. Создан репозиторий на GitHub
4. Склонирован репозиторий на локальный компьютер
5. Создан файл `README.md` с описанием проекта
6. Создан файл `.gitignore` с настройками исключений
7. Создана ветка `develop`
8. Создан файл `CONTRIBUTING.md`
9. Выполнен коммит и push изменений
10. Создан Pull Request из `develop` в `main`
11. Pull Request смержен, ветка `develop` удалена
