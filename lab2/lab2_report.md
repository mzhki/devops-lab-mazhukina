...
Сделала коммит в ветку `develop` — в логах Actions выводится сообщение про development-сервер:

![Actions — деплой из develop](../images/lab2-actions-develop-deploy.png)

Сделала коммит в ветку `main` — выводится сообщение про production:
